...
function CountdownSection({ weddingData }) {
  ...
  return (
    <section id="countdown" ref={ref} className="relative pt-12 pb-72 overflow-hidden bg-[var(--color-bg)]">
      {/* Background image */}
      <div className="absolute inset-0">
        <img src="/images/counting_days_background_without_border_2.PNG" alt="" className="w-full h-full object-cover" />
      ...
      <div className={`max-w-lg mx-auto px-6 pt-0 pb-16 relative z-10 ${inView ? 'fade-up' : 'opacity-0'}`}>
        ...
        <p className="section-subtitle text-lg mb-4">Until we say "I do"</p>
